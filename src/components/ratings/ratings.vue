...
<div>
	...
	<split></split>
	<ratingselect :onlyContent="onlyContent" :selectType="selectType" :desc="desc" :ratings="ratings"></ratingselect>
	<div class="rating-wrapper">
		<ul>
			<li v-show='needShow' v-for="rating in ratings" class="rating-item border-1px">
				<div class="avatar">
				...
				<div class="content">
					...
					<div class="recommend" v-show="rating.recommend && rating.recommend.length">
						<span class="icon-thumb_up okok"></span>
